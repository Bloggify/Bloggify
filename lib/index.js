...
BloggifyLib.post = {
  ...
  , edit: function (query, editedPost, callback) {
    ...
    // TODO By query
  , fetch: function (req, query, fileContent, callback, noAttachContent) {
  ...
  , handle: function (req, cPost, postContent, callback, noAttachContent) {
        callback = callback || function () {};
