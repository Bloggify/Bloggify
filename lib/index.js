...
module.exports = class Bloggify extends EventEmitter {
     ...
     *     - `session` (Boolean): Wether to enable session management (default: `true`).
     ...
     *     - `publicMain` (String): The public directory endpoint (default: `"/@/bloggify/public/"`)
     *     - `publicCore` (String): The public core endpoint (default: `"/@/bloggify/core/"`)
     *     - `publicTheme` (String): The theme endpoint (default: `"/@/bloggify/theme/"`)
     *     - `cssUrls` (String): The CSS assets endpoint (default: `"/@/bloggify/css-urls/"`)
