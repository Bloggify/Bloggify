...
module.exports = class Bloggify extends EventEmitter {
    ...
    constructor (options) {
        ...
        const PATH_STYLESHEETS_MANIFEST = Path.join(options.root, "app/assets/stylesheets/application.css")
        const PATH_JAVASCRIPTS_MANIFEST = Path.join(options.root, "app/assets/javascripts/application.js")
