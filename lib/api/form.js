...
Form.logout = function (req, res, formData) {
...
Form.login = function (req, res, formData) {
...
Form.reinitCache = function (req, res, formData) {
    Bloggify.session.isLoggedIn(req, function (err, sessionData) {
...
var newPost = Form["new-post"] = {};
newPost.handler = function (req, res, formData) {
    Bloggify.session.isLoggedIn(req, function (err, sessionData) {
...
var editPost = Form["edit-post"] = {};
editPost.handler = function (req, res, formData) {
    Bloggify.session.isLoggedIn(req, function (err, sessionData) {
