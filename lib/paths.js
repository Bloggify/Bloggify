...
class BloggifyPaths {
     ...
     * @returns {object} The BloggifyPaths instance.
     */
    ...
    initPublicPaths() {
        ...
        const customStaticPaths = Array.isArray(this._.options.static_dirs)
            ? this._.options.static_dirs
            : [];
        this._publicPaths = [
            ...customStaticPaths,
     ...
     * 
     *    - `bundle_url`: The url of the bundle.
     *    - `local_dir`: The local directory of the bundle.
     */
    getBundlePaths(name) {
        name = name || "main";
        return {
            bundle_url: `${this.publicUrls.core}/${this.envLabel}-bundles/${name}/`,
            bundle_dir: `${this.public.core}/${this.envLabel}-bundles/${name}/`,
        };
    }
     ...
     * @returns {Array}  The public paths.
     */
    getPublicPaths() {
     ...
     * @returns {type}        The plugin's path.
     */
    pluginPath(name) {
