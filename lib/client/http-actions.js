...
module.exports = {
    request (opts, cb) {
        ...
        *  - `headers` (Object)    The headers information.
        *  - `url`     (String)    The access URL.
        *  - `action`  (Object)    The main source of information.
        *  - `method`  (Function)  Used to access the code.
        *  - `data`    (String)    Used to show the process status.
